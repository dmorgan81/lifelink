...
#define PLAYER_ONE_STORAGE_KEY STORAGE_PLAYER_ONE_KEY
#define PLAYER_ONE_NAME_STORAGE_KEY STORAGE_PLAYER_ONE_NAME_KEY
#define PLAYER_TWO_STORAGE_KEY STORAGE_PLAYER_TWO_KEY
#define PLAYER_TWO_NAME_STORAGE_KEY STORAGE_PLAYER_TWO_NAME_KEY
